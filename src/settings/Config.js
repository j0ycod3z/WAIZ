...
let GRAPH_URL = `http://54.169.76.28:8000/graphql`; //let GRAPH_URL = `http://${domain}:8000/graphql`;
let API_URL = `http://54.169.76.28:8000/api`; //let API_URL = `http://${domain}:8000/api`;
let APP_URL = `http://54.169.76.28:3000`; //let APP_URL = `http://${domain}:3000`;
