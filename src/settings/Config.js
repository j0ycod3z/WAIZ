...
let domain = '18.143.66.215';
let GRAPH_URL = `http://52.77.254.255:8000/graphql`; //let GRAPH_URL = `http://${domain}:8000/graphql`;
let API_URL = `http://52.77.254.255:8000/api`; //let API_URL = `http://${domain}:8000/api`;
let APP_URL = `http://52.77.254.255:3000`; //let APP_URL = `http://${domain}:3000`;
