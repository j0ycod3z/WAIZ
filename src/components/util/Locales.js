...
const Locales = {
  ...
  sign_up_title: [
    "Do you want to use canou for business or education purposes?",
    "¿Desea utilizar canou para fines comerciales o educativos?"
  ],
  sign_up_notice: [
  ...
  password_changed_notice: [
    "Now you can enter canou with your new password",
    "Ahora puedes ingresar a canou con tu nueva contraseña"
  ],
