...
import c from "components/auth/SignupWelcome.module.scss";
...
function Signup(props) {
  ...
  const onClickBack = () => history.replace(`/login`);
    ...
    <div className={c.module}>
      ...
      <div className={cx("container")}>
        <div className={cx("row", "d-flex", "justify-content-center")}>
          <div className={cx("col-md-6", c.formCard)}>
            <h2 className={c.title}>{lcs("one_more_step")}</h2>
            <p>{lcs("email_confirmation_notice")}.</p>
            <br/>
