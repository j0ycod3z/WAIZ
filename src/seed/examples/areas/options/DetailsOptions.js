...
import styles from "resources/css/seed/examples/areas/options/DetailsOptions.module.css";

function AreaDetailsOptions(props) {

    const { url } = props.match;
    const { area_id } = props.match.params;

    const [callDelete, qDelete] = useDelete(queries.DELETE_AREA, {
      onCompleted: (data) => {
...
export default AreaDetailsOptions;