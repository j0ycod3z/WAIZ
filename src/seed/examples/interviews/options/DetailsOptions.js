...
import styles from "resources/css/seed/examples/interviews/options/DetailsOptions.module.css";

function InterviewDetailsOptions(props) {

    const { url } = props.match;
    const { interview_id } = props.match.params;

    const [callDelete, qDelete] = useDelete(queries.DELETE_INTERVIEW, {
      onCompleted: (data) => {
