...
import styles from "resources/css/seed/examples/trls/options/DetailsOptions.module.css";

function TrlDetailsOptions(props) {

    const { url } = props.match;
    const { trl_id } = props.match.params;

    const [callDelete, qDelete] = useDelete(queries.DELETE_TRL, {
      onCompleted: (data) => {
...
export default TrlDetailsOptions;