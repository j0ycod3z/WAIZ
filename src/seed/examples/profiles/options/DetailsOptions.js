...
import styles from "resources/css/seed/examples/profiles/options/DetailsOptions.module.css";

function ProfileDetailsOptions(props) {

    const { url } = props.match;
    const { profile_id } = props.match.params;

    const [callDelete, qDelete] = useDelete(queries.DELETE_PROFILE, {
      onCompleted: (data) => {
