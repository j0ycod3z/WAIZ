...
import styles from "resources/css/seed/examples/fits/options/DetailsOptions.module.css";

function FitDetailsOptions(props) {

    const { url } = props.match;
    const { fit_id } = props.match.params;

    const [callDelete, qDelete] = useDelete(queries.DELETE_FIT, {
      onCompleted: (data) => {
...
export default FitDetailsOptions;